/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env-file .dev.vars.example` (hash: 4c7cf9a8e9fbe540cc5be9151e3190eb)
// Runtime types generated with workerd@1.20251008.0 2025-10-16 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		AUTH_KV_AUTHCODES: KVNamespace;
		AUTH_KV_ACCESSTOKENS: KVNamespace;
		AUTH_KV_REFRESHTOKENS: KVNamespace;
		AUTH_KV_SESSIONS: KVNamespace;
		AUTH_KV_KEYS: KVNamespace;
		AUTH_KV_USERS: KVNamespace;
		...
		APPLE_CLIENT_ID: "club.icssc.auth";
		APPLE_TEAM_ID: "66682RDDDK";
		APPLE_KEY_ID: "432Q2H2SLP";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ISSUER" | "TOKEN_TTL_SECONDS" | "CODE_TTL_SECONDS" | "REFRESH_TTL_SECONDS" | "SESSION_TTL_SECONDS" | "GOOGLE_REDIRECT_URI" | "GOOGLE_CLIENT_ID" | "APPLE_CLIENT_ID" | "APPLE_TEAM_ID" | "APPLE_KEY_ID" | "APPLE_REDIRECT_URI" | "GOOGLE_CLIENT_SECRET" | "STATE_SIGNING_SECRET">> {}
}
